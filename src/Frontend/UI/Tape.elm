module Frontend.UI.Tape exposing (display)
...
display : { sizeInPx : Int, color : Color } -> Svg msg
display { sizeInPx, color } =
    svg
        [ SvgAttr.height <| String.fromInt sizeInPx
        , SvgAttr.version "1.1"
        , SvgAttr.viewBox "0 0 109 78"
        ]
        [ Svg.g
            [ SvgAttr.stroke <| Color.toCssString <| Frontend.UI.Theme.fromElmUI color
            ]
            [ path
